...
from ai.models.yolo import ClassificationModel, Detect, DetectionModel, SegmentationModel
from ai.utils.dataloaders import LoadImages
from ai.utils.general import (LOGGER, Profile, check_dataset, check_img_size, check_requirements, check_version,
...
def export_openvino(file, metadata, half, int8, data, prefix=colorstr('OpenVINO:')):
    ...
    if int8:
        ...
        from ai.utils import create_dataloader
        core = Core()
